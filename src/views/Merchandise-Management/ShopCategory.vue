  ...
  methods: { // get items
    getDataFromApi() {
      ...
      if (this.searchActive) {
        axios
          .get("ShopCategory/search/" + this.searchData)
          .then((response) => {
    ...
    getArchiveData() {
      ...
      if (this.searchActiveArchive) {
        axios
          .get("ShopCategory/archiveSearch/" + this.searchDataArchive)
          .then((response) => {
            if (response.data.success) {
              if (response.data.data != null) {
        ...
        axios
          .post("ShopCategory/findAllArchive")
          .then((response) => {
            if (response.data.success) {
              this.archiveItems = response.data.data;
              this.archiveItemsCount = this.archiveItems.length;
    ...
    archiveItemConfirm() {
      var itemId = this.formData.shopCategoryId;
      this.isLoading = true;
      axios
        .post("ShopCategory/archive/" + itemId)
        .then((response) => {
          if (response.data.success) {
    ...
    restoreItemConfirm() {
      ...
      this.isLoading = true;
      axios
        .post("ShopCategory/restore/" + itemId)
        .then((response) => {
          if (response.data.success) {
    ...
    deleteItemConfirm() {
      ...
      axios
        .delete("ShopCategory/delete/" + itemId)
        .then((response) => {
          if (response.data.success) {
