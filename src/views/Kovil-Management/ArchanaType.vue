...
export default {
  mounted() {
    store.dispatch("menuTitle/setSubMenuTitle", "அர்ச்சனை வகைகள்");
  },
  components: {},
  data() {
    return {
  ...
  methods: {
    ...
    getDataFromApi() {
      ...
      if (this.searchActive) {
        axios
          .get("ArchanaType/search/" + this.searchData)
          .then((response) => {
    ...
    getArchiveData() {
      ...
      if (this.searchActiveArchive) {
        axios
          .get("ArchanaType/archiveSearch/" + this.searchDataArchive)
          .then((response) => {
            if (response.data.success) {
              if (response.data.data != null) {
        ...
        axios
          .post("ArchanaType/findAllArchive")
          .then((response) => {
            if (response.data.success) {
              this.archiveItems = response.data.data;
              this.archiveItemsCount = this.archiveItems.length;
    ...
    archiveItemConfirm() {
      var itemId = this.formData.archanaTypeId;
      this.isLoading = true;
      axios
        .post("ArchanaType/archive/" + itemId)
        .then((response) => {
          if (response.data.success) {
    ...
    restoreItemConfirm() {
      ...
      this.isLoading = true;
      axios
        .post("ArchanaType/restore/" + itemId)
        .then((response) => {
          if (response.data.success) {
    ...
    deleteItemConfirm() {
      ...
      axios
        .delete("ArchanaType/delete/" + itemId)
        .then((response) => {
          if (response.data.success) {
