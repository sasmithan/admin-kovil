...
export default {
  mounted() {
    store.dispatch("menuTitle/setSubMenuTitle", "விஷேட பூஜைகள்");
  },
  components: {},
  data() {
    return {
  ...
  methods: {
    ...
    getDataFromApi() {
      ...
      if (this.searchActive) {
        axios
          .get("SpecialPooja/search/" + this.searchData)
          .then((response) => {
    ...
    getArchiveData() {
      ...
      if (this.searchActiveArchive) {
        axios
          .get("SpecialPooja/archiveSearch/" + this.searchDataArchive)
          .then((response) => {
            if (response.data.success) {
              if (response.data.data != null) {
        ...
        axios
          .post("SpecialPooja/findAllArchive")
          .then((response) => {
            if (response.data.success) {
              this.archiveItems = response.data.data;
              this.archiveItemsCount = this.archiveItems.length;
    ...
    archiveItemConfirm() {
      var itemId = this.formData.specialPoojaId;
      this.isLoading = true;
      axios
        .post("SpecialPooja/archive/" + itemId)
        .then((response) => {
          if (response.data.success) {
    ...
    restoreItemConfirm() {
      ...
      this.isLoading = true;
      axios
        .post("SpecialPooja/restore/" + itemId)
        .then((response) => {
          if (response.data.success) {
    ...
    deleteItemConfirm() {
      ...
      axios
        .delete("SpecialPooja/delete/" + itemId)
        .then((response) => {
          if (response.data.success) {
