    ...
    setDefault(){
     ...
     getArchiveData() {
      ...
      if (this.searchActiveArchive) {
        axios
        .get("ShopProduct/productArchiveSearch/" + this.searchDataArchive+"/"+id)
          .then((response) => {
        ...
        axios
          .post("ShopProduct/findProductAllArchive/"+id)
          .then((response) => {
            if (response.data.success) {
              this.archiveItems = response.data.data;
              this.archiveItemsCount = this.archiveItems.length;
 ...
 setPaginationArchive() {
    ...
    async refreshData() {
      ...
      if (this.searchActive) {
        axios
          .get("ShopProduct/productSearch/" + this.searchData+"/"+id)
          .then((response) => {
            if (response.data.success) {
              if (response.data.data != null) {
      ...
      await axios
          .post("ShopProduct/find/product/"+id)
          .then((response) => {
            if (response.data.success) {
