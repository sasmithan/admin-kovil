    ...
    <ModalBody class="">
      <div class="grid">
        <div class="w-full mb-2">
          <label for="regular-form-1" class="form-label">Archana Type</label>
...
export default {
  ...
  methods: {
    ...
    async saveForm() {
      ...
      this.saving = true;
      await axios
        .post("ArchanaType/Create", this.formData)
        .then((response) => { 
          if (response.data.success) {
            this.modalClose();
            this.getDataFromApi();
    ...
    async updateForm() {
      var id = this.formData.archanaTypeId;
      this.updating = true;
      await axios
        .put("ArchanaType/Edit/" + id, this.formData)
        .then((response) => {
          if (response.data.success) {
            this.modalClose();
            this.getDataFromApi();
