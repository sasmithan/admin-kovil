      ...
      <div class="grid grid-cols-3 lg:gap-4 md:gap-4 gap-2">
        <!-- <div class="w-full">
          ...
          <div class="flex flex-col space-y-1">
            <v-select v-model="formData.shopId" disabled placeholder="SELECT" class="style-chooser cursor-pointer"
        ...
        <div class="w-full">
          ...
          <div class="flex flex-col space-y-1">
            <v-select v-model="formData.productId" placeholder="SELECT" class="style-chooser cursor-pointer"
